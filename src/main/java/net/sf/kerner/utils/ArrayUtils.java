...
public class ArrayUtils {
     ...
     * @param arr
     *            array to check
     * @return true, if {@code arr} is {@code null}, empty or if it contains only {@code null} elements; {@code false}
     *         otherwise
     */
     ...
     * @param o
     *            Object to ckeck
     * @return {@code true}, if this object represents an array; {@code false} otherwise
     */
