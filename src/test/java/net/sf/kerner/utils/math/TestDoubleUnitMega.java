...
public class TestDoubleUnitMega {
    ...
    public final void testToPicos01() {
        assertEquals(1.0E+18, u.toPicos(1), 0);
    }

    @Test
    public final void testToNanos() {
        assertEquals(1.0E+15, u.toNanos(1), 0);
    }

    @Test
    public final void testToMicros01() {
        assertEquals(1.0E+12, u.toMicros(1), 0);
    }
    ...
    public final void testToKilos01() {
        assertEquals(1.0E+3, u.toKilos(1), 0);
    }

    @Test
    public final void testToMegas01() {
        assertEquals(1, u.toMegas(1), 0);
    }
    ...
    public final void testToTeras01() {
        assertEquals(1.0E-6, u.toTeras(1), 0);
    }
