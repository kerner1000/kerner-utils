...
public class TestDoubleUnitUnit {
	...
	public final void testToPicos01() {
		assertEquals(1.0E+12, u.toPicos(1), 0);
	}

	@Test
	public final void testToNanos01() {
		assertEquals(1.0E+9, u.toNanos(1), 0);
	}
	...
	public final void testToGigas() {
		assertEquals(1.0E-9, u.toGigas(1), 0);
	}

	@Test
	public final void testToTeras() {
		assertEquals(1.0E-12, u.toTeras(1), 0);
	}
